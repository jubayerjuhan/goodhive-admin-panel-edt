        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li
                className="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium cursor-pointer text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                onClick={handleLogout}
              >
                <img className="w-4 h-4 invert" src="/images/icon/logout.svg" />
                Logout
              </li>
              {/* <!-- Menu Item Settings --> */}
            </ul>
